...
func ConvertCreateUserResponse(user *models.User) *CreateUserResponse {
...
func ConvertGetUserResponse(user *models.User) *GetUserResponse {
...
func ConvertDeleteUserResponse(user *models.User) *DeleteUserResponse {
...
func ConvertRequest(i interface{}) (*models.User, error) {
	switch v := i.(type) {
...
func convertCreateUserRequest(req *CreateUserRequest) *models.User {
	return &models.User{
